...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Book Manage Language Lines
    |--------------------------------------------------------------------------
    |
    | The following language lines are used during book manage for various
    ...
    */
    ...
    'name_pattern' => '[A-Za-z0-9 \t]{2,100}*\p{L}+',
    'name_notice' => 'No special characters, 2->100 characters',
    'author_pattern' => '[.,\-A-Za-z0-9 \t]{3,}*\p{L}+',
